...
| <img align="left" width="22px" alt="." src="/assets/icons/clean/default.svg"> | `clean` | Elimina los directorios `build`,  `install`,  `log`, `src` creados por `colcon build` |
...
| <img align="left" width="22px" alt="." src="/assets/icons/unsynchronize/default.svg"> | `sinchronize` | Se conecta a topicos como publicador o subscriptor |
| <img align="left" width="22px" alt="." src="/assets/icons/synchronize/default.svg"> | `unsinchronize` | Se desconecta de topicos anteriormente conectado desde la IDE |
...
<img align="left" height="220px" alt="." src=".releases/fonts/nunito-sans.png">
<img align="left" height="220px" alt="." src=".releases/fonts/ubuntu-mono.png">
<img align="left" height="220px" alt="." src="https://www.nerdfonts.com/assets/img/previews/UbuntuMono%20Nerd%20Font.svg">
